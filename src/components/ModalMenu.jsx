    ...
    <>
      {
        (selector===true)
            ...
            ?<nav className={` bg-gradient animate__animated animate__zoomIn animate__faster z-20 fixed  h-screen w-screen text-white font-bold text-5xl lg:text-6xl flex flex-col justify-center items-center`}>
