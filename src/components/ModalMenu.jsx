...
export const ModalMenu = () => {
  ...
  return (
    <>
      {selector === true ? (
        <nav
          className={`bg-gradient animate__animated animate__zoomIn animate__faster py-16 z-20 fixed h-screen w-screen text-white flex flex-col justify-between items-center`}
        >
          <div className="flex flex-col">
            ...
            <Link
              to="/contact"
              onClick={handleClosedMenu}
              className=" text-center font-bold text-4xl mt-6"
            >
              Contacto
            </Link>
