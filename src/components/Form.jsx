...
export const Form = () => {
  ...
  return (
    ...
    >
      ...
      <Button
        type="submit"
        className="bg-gradient w-20 flex py-2 justify-center items-center m-auto text-base"
      >
        ENVIAR
      </Button>
      ...
      <input
        type="hidden"
        name="_next"
        value="https://nicolaspoteljunot.github.io/SouthChain/?#/contact"
      />
